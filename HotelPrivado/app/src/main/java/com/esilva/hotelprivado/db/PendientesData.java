...
public class PendientesData {
    ...
    public int dt_id_transac=0;

    public PendientesData() {

    }

    public PendientesData(String dt_consecutivo, String dt_id_producto, String dt_nameImage, String dt_nombre_es, String dt_nombre_in, String dt_precio, String dt_descripcion_es, String dt_descripcion_in, String dt_type_product, String dt_num_articulos, String dt_num_vendidos,int id_tr) {
        ...
        this.dt_id_transac = id_tr;
    }

    public int getDt_id_transac() {
        return dt_id_transac;
    }

    public void setDt_id_transac(int dt_id_transac) {
        this.dt_id_transac = dt_id_transac;
    }
    ...
    private static final String JSON_ID_TR = "id_tr";
    public String Serializar(){
        ...
        try {
            ...
            jsonObject.put(JSON_ID_TR,dt_id_transac);
    ...
    public PendientesData DesSerializar(String serializer){
        ...
        try {
            ...
            dt_id_transac = Integer.valueOf(jsonObject.getString(JSON_ID_TR));
        } catch (JSONException e) {
            e.printStackTrace();
            return null;
        }
